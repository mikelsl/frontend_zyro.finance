...
import { useZilpayWallet } from '../../zilliqa/connector'
...
export default function ClaimPopup() {
  ...
  const userHasAvailableclaim: boolean = useUserHasAvailableClaim(account?.base16)
  const unclaimedAmount: TokenAmount | undefined = useUserUnclaimedAmount(account?.base16)
