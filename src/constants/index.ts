...
import { AbstractConnector as EAbstractConnector } from '@web3-react/abstract-connector'
...
export const SUPPORTED_ETHEREUM_WALLETS: { [key: string]: EWalletInfo } = {
  INJECTED: {
    connector: injected,
    name: 'Injected',
